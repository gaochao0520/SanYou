...
namespace Tc.DAL
{
    ...
    public partial class TcLinks
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ID", "TcLinks");
        }
        ...
        public int Add(Tc.Model.TcLinks model)
        {
            ...
            strSql.Append("Name,Types,Url,LogoUrl,Paixu,IsXianshi,Addtime)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Name,Types,Url,LogoUrl,Paixu,IsXianshi,Addtime from TcLinks ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,Name,Types,Url,LogoUrl,Paixu,IsXianshi,Addtime ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,Name,Types,Url,LogoUrl,Paixu,IsXianshi,Addtime ");
            strSql.Append(" FROM TcLinks ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TcLinks T ");
