...
namespace Tc.DAL
{
    ...
    public partial class TcShi
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ID", "TcShi");
        }
        ...
        public int Add(Tc.Model.TcShi model)
        {
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@ShengCode", SqlDbType.Char,6),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Code,Name,ShengCode,Paixu from TcShi ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,Code,Name,ShengCode,Paixu ");
            strSql.Append(" FROM TcShi ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TcShi T ");
