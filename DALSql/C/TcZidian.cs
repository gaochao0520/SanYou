...
namespace Tc.DAL
{
    ...
    public partial class TcZidian
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ID", "TcZidian");
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Name,Types,Paixu,Pid from TcZidian ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,Name,Types,Paixu,Pid ");
            strSql.Append(" FROM TcZidian ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TcZidian T ");
