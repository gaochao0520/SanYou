...
namespace Tc.DAL
{
    ...
    public partial class TcConfig
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ID", "TcConfig");
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Ename,Name,Types,Content from TcConfig ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,Ename,Name,Types,Content ");
            strSql.Append(" FROM TcConfig ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TcConfig T ");
