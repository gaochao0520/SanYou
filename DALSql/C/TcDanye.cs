...
namespace Tc.DAL
{
    ...
    public partial class TcDanye
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("ID", "TcDanye");
        }
        ...
        public int Add(Tc.Model.TcDanye model)
        {
            ...
            strSql.Append("Ename,Types,Name,Url,Tupian,Fenlei,Content)");
            strSql.Append(" values (");
            strSql.Append("@Ename,@Types,@Name,@Url,@Tupian,@Fenlei,@Content)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
					new SqlParameter("@Ename", SqlDbType.NVarChar,200),
            ...
            parameters[5].Value = model.Fenlei;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,Ename,Types,Name,Url,Tupian,Fenlei,Content from TcDanye ");
            strSql.Append(" where ID=@ID");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,Ename,Types,Name,Url,Tupian,Fenlei,Content ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ID,Ename,Types,Name,Url,Tupian,Fenlei,Content ");
            strSql.Append(" FROM TcDanye ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from TcDanye T ");
